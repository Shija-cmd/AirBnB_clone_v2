...
env.hosts = ["52.90.12.252", "54.237.20.143"]   # <IP of web-01>, <IP of web-02>


def do_pack():
    """all contents from web_static into .tgz archive
    """
...
def do_deploy(archive_path):
    """static archive to the web servers"""
    ...
    # cleaning up old release and remove it.
